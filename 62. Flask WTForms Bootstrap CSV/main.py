...
class CafeForm(FlaskForm):
    ...
    opn = DateTimeField('Open', format='%H:%M', validators=[DataRequired()])
    close = DateTimeField('Close', format='%H:%M', validators=[DataRequired()])
    cafe = SelectField('Coffee', choices=cafe_choices, validators=[DataRequired()])
